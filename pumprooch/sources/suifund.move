module pumprooch::suifund {
    ...
    use pumprooch::utils::{mul_div, get_remain_value};
    use moveos_std::display;
    use moveos_std::object;
    use rooch_framework::coin_store;
    use moveos_std::table;
    use moveos_std::tx_context::sender;
    use pumprooch::comment::Comment;
    ...
    fun init() {
        let deployer = sender();
        let deploy_record = DeployRecord {version: VERSION, record: table::new(), categorys: table::new(), balance: coin_store::create_coin_store<RGas>(), base_fee: BASE_FEE, ratio: 1 };
    ...
    public fun deploy_non_entry(
        ...
        let deploy_coin = account_coin_store::withdraw<RGas>(account, (deploy_fee as u256));
        ...
        let project_record = object::new(ProjectRecord {
            ...
            cancel: false,
            balance: coin_store::create_coin_store<RGas>(),
            ratio,
            start_time_ms,
    ...
    public fun do_mint(
        ...
        let project_fee = account_coin_store::withdraw<RGas>(account, (project_sui_value as u256));
        ...
        let locked_sui = account_coin_store::withdraw<RGas>(account, (locked_sui_value as u256));
    ...
    public fun reference_reward(reward: Coin<RGas>, sender: address, recipient: address, project_record_obj: &Object<ProjectRecord>) {
    ...
    public entry fun edit_image_url(
        ...
        let project_record = object::borrow_mut(project_record_obj);
        let deploy_record = object::borrow_mut(deploy_record_obj);
        let edit_coin = account_coin_store::withdraw<RGas>(account, (SUI_BASE / 10 as u256));
    ...
    fun new_supporter_reward(
        ...
        let store = coin_store::create_coin_store<RGas>();
